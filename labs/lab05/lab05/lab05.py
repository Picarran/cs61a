...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t):
        ...
        return tree(label(t))
    return tree(label(t), [replace_loki_at_leaf(bs,lokis_replacement) for bs in branches(t)])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    a =distance(city_c, city_a)
    b = distance(city_c, city_b)
    if a<b:
